          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Co-Living in Hyderabad"
            ...
            <div>
              <label className="block text-neutral-700 font-medium mb-2 flex items-center gap-2">
                <FaList className="text-primary-500" /> Shared Amenities
              </label>
              <div className="grid grid-cols-2 gap-3">
                {["Gym", "Lounge", "Kitchen"].map((option) => (
                  <label key={option} className="flex items-center gap-2 text-neutral-700">
                    <input
                      type="checkbox"
                      value={option}
                      ...
                      onChange={() => {
                        const updated = formData.amenities.includes(option)
                          ? formData.amenities.filter((a) => a !== option)
                          : [...formData.amenities, option];
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="e.g., Vibrant co-living space with community events..."
                className="w-full p-3 border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 bg-neutral-50 shadow-sm hover:shadow-md transition-shadow duration-300"
                rows="4"
                required
              />
